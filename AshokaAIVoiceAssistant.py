...
def run_ashoka():
    ...
    while listening:
        ...
        if 'ashoka' in command:
            ...
            elif 'tell me about our chairperson' in command:
...
stop_button = Button(root, text="Stop", command=stop_listening, bg="orange", fg="white", font=("Arial", 12))
stop_button.pack(pady=10)

exit_button = Button(root, text="Exit", command=exit_application, bg="red", fg="white", font=("Arial", 12))
